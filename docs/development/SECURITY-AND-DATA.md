...
- Dados de desenvolvimento e teste devem ser **sintéticos** — gerados especificamente para não corresponder a nenhuma transação real de Victoria ou de terceiros.
